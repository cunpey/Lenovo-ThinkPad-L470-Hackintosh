 ...
 *
 * Disassembly of SSDT-2-ProjSsdt.aml, Sat Jan  2 18:05:52 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001739 (5945)
 *     Revision         0x02
 *     Checksum         0x38
 *     OEM ID           "LENOVO"
...
{
    External (_SB_.PCI0.LPCB.EC__.DKID, MethodObj)    // 0 Arguments (from opcode)
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x99, 0x12, 0x80, 0x01, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x99, 0x10, 0x80, 0x02, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x24, 0x01, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00 
        })
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS07.WCAM)
    {
