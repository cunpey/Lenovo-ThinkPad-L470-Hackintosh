 ...
 *
 * Disassembly of DSDT.aml, Sat Jan  2 18:05:51 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F3DC (127964)
 *     Revision         0x02
 *     Checksum         0x24
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0xDB558000, 0x072C)
        ...
        Device (EC)
        {
            ...
            Device (HKEY)
            {
                ...
                Method (SMKS, 1, NotSerialized)
                {
                    If (And (Arg0, 0x01))
                    {
                        Store (0x00, \_SB.PCI0.LPCB.EC.HKLK)
                    }
                    Else
                    {
                        Store (0x01, \_SB.PCI0.LPCB.EC.HKLK)
                    }
            ...
            Method (GBIF, 3, NotSerialized)
            {
                ...
                If (Arg2)
                {
                    ...
                    Or (Arg0, 0x06, HIID)
                    Sleep (0x14)
                    Store (RECB(0x60,128), Index (Arg1, 0x09))
                    Or (Arg0, 0x04, HIID)
                    Sleep (0x14)
                    ...
                    Or (Arg0, 0x05, HIID)
                    Sleep (0x14)
                    Store (RECB(0x60,128), Index (Arg1, 0x0C))
                }
                Else
                {
            ...
            Method (GBIX, 3, NotSerialized)
            {
                ...
                If (Arg2)
                {
                    ...
                    Or (Arg0, 0x06, HIID)
                    Store (RECB(0x60,128), Index (Arg1, 0x10))
                    Or (Arg0, 0x04, HIID)
                    Name (BTYP, Buffer (0x05)
                    {
                         0x00, 0x00, 0x00, 0x00, 0x00                   
                    ...
                    Or (Arg0, 0x05, HIID)
                    Store (RECB(0x60,128), Index (Arg1, 0x13))
                }
                Else
                {
                    Store (0xFFFFFFFF, Index (Arg1, 0x02))
            ...
            {
                If (LEqual (\_SB.GGIV (0x02030005), 0x01))
                {
                    If (LEqual (\_SB.PCI0.LPCB.EC.ASBF, One))
                    {
                        If (LNotEqual (\_SB.PCI0.BADR, 0xFFFFFFFF))
                        {
                            OperationRegion (AMSA, SystemMemory, \_SB.PCI0.BADR, 0x00010000)
                ...
                Else
                {
                    Store (Zero, \_SB.PCI0.LPCB.EC.ASBF)
                }
            }

            Method (_Q91, 0, NotSerialized)  // _Qxx: EC Query
            {
                Store (\_SB.PCI0.LPCB.EC.CPUJ, Local0)
                Store (\UCCT (Local0), Local1)
                Store (Local1, \_SB.PCI0.LPCB.EC.CTMP)
            }
            ...
            Name (BUF0, ResourceTemplate()
{
    IRQNoFlags() { 0, 8, 11, 15 }
        ...
        Device (MOU)
        {
            Name (_HID, EisaId ("LEN2044"))  // _HID: Hardware ID
            ...
            Method (MHID, 0, NotSerialized)
            {
                ...
                {
                    Store (0x5120AE30, _HID)
                }
                Else
                {
                    Store (0x4420AE30, _HID)
                }
            }
        }
    }
    ...
    Method (OPTS, 1, NotSerialized)
    {
        ...
        If (Local0)
        {
            ...
            If (LEqual (Arg0, 0x03))
            {
                Store (0x00, \_SB.PCI0.LPCB.EC.S3ST)
                Store (0x01, \_SB.PCI0.LPCB.EC.S3ST)
                \VVPD (0x03)
                \SLTP ()
            ...
            If (LEqual (Arg0, 0x04))
            {
                Store (0x00, \_SB.PCI0.LPCB.EC.S4ST)
                Store (0x01, \_SB.PCI0.LPCB.EC.S4ST)
                If (VDSP)
                {
                    Store (Zero, SHA1)
                }
            ...
            If (LEqual (Arg0, 0x05))
            {
                Store (0x00, \_SB.PCI0.LPCB.EC.S5ST)
                Store (0x01, \_SB.PCI0.LPCB.EC.S5ST)
                \SLTP ()
                \AWON (0x05)
            }
...
Store (0x00, P80D)
    ...
    Method (OWAK, 1, NotSerialized)
    {
        ...
        If (LEqual (Arg0, 0x03))
        {
            ...
            If (And (\_SB.PCI0.LPCB.EC.HWAK, 0x10))
            {
                Notify (\_SB.LID, 0x02)
                Notify (\_SB.SLPB, 0x02)
            }

            If (And (\_SB.PCI0.LPCB.EC.HWAK, 0x04))
            {
                Notify (\_SB.LID, 0x02)
                Notify (\_SB.SLPB, 0x02)
            }
        ...
        If (LLess (Arg0, 0x04))
        {
            If (LOr (And (\RRBF, 0x02), And (\_SB.PCI0.LPCB.EC.HWAK, 0x02)))
            {
        ...
        Store (Zero, \RRBF)
        Store (0x00, \_SB.PCI0.LPCB.EC.HWAK)
...
Return (Package (0x02)
    ...
    Scope (\_GPE)
    {
        ...
        {
            Store (0x0D, P80H)
            Store (\_SB.PCI0.LPCB.EC.HWAK, Local0)
            Store (Local0, \RRBF)
            Sleep (0x0A)
            If (And (Local0, 0x02)){}
            If (And (Local0, 0x04))
    ...
    OperationRegion (MNVS, SystemMemory, 0xDB568018, 0x1000)
    ...
    Scope (\_SB.PCI0.LPCB)
    {
        ...
        OperationRegion (RFIO, SystemMemory, 0xFDAF0538, 0x04)
        Field (RFIO, DWordAcc, NoLock, Preserve)
        {
            RFOF,   1, 
            Offset (0x04)
        }

        OperationRegion (BTIO, SystemMemory, 0xFDAF0568, 0x04)
        Field (BTIO, DWordAcc, NoLock, Preserve)
        {
            BTON,   1, 
            Offset (0x04)
        }

        OperationRegion (VGON, SystemMemory, 0xFDAE0558, 0x04)
        ...
        OperationRegion (DGHR, SystemMemory, 0xFDAE0560, 0x04)
        ...
        OperationRegion (DGPW, SystemMemory, 0xFDAE0568, 0x04)
        Field (DGPW, DWordAcc, NoLock, Preserve)
        {
                ,   1, 
            PWGD,   1, 
            Offset (0x04)
        ...
        OperationRegion (GC6O, SystemMemory, 0xFDAE0570, 0x04)
        ...
        OperationRegion (GC6I, SystemMemory, 0xFDAE0578, 0x04)
        ...
        OperationRegion (PMI1, SystemIO, 0x1800, 0x0100)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        {
            If (\_SB.PCI0.LPCB.EC.HKEY.MHKK (0x01, 0x01))
            {
                \_SB.PCI0.LPCB.EC.HKEY.MHKQ (0x1001)
            }
        }
        ...
        {
            // _Q64 (Fn+F8) Wireless disable key (remap to F18)
        ...
        {
            If (\_SB.PCI0.LPCB.EC.HKEY.MHKK (0x01, 0x0100))
            {
                \_SB.PCI0.LPCB.EC.HKEY.MHKQ (0x1009)
            }
        ...
        {
            If (\_SB.PCI0.LPCB.EC.HKEY.MHKK (0x01, 0x0400))
            {
                \_SB.PCI0.LPCB.EC.HKEY.MHKQ (0x100B)
            }
        }

        Method (_Q1B, 0, NotSerialized)  // _Qxx: EC Query
        {
            \_SB.PCI0.LPCB.EC.HKEY.MHKQ (0x100C)
        }
        ...
        {
            // _Q66 (Fn+F9) Settings key (remap to F13)
        ...
        {
            Store (0x7F, P80H)
            Fatal (0x01, 0x80010000, 0x00010986)
        }
        ...
        Scope (\_SB.PCI0.LPCB.EC)
        {
            ...
            {
                // _Q6A (Fn+F4) Microphone Mute key (remap to F17)
                Notify(KBD, 0x016b)
                Notify(KBD, 0x01eb) 
            }
        }
        ...
        Scope (\_SB.PCI0.LPCB.EC.HKEY)
        {
            ...
            Method (MMTS, 1, NotSerialized)
            {
                ...
                ElseIf (LEqual (Arg0, 0x02))
                {
                    \_SB.SGOV (0x02020016, 0x00)
                }
                ElseIf (LEqual (Arg0, 0x03)){}
                Else
                {
                    \_SB.SGOV (0x02020016, 0x01)
                }
            }
        }
        ...
        Scope (\_SB.PCI0.LPCB.EC)
        {
            ...
            {
                Store (\_SB.GGIV (0x02030016), Local0)
                Store (\_SB.GGIV (0x02030001), Local1)
                Store (\_SB.GGIV (0x02030002), Local2)
                Store (\_SB.GGIV (0x02030003), Local3)
        ...
        Scope (\_SB.PCI0.LPCB.EC)
        {
            ...
            {
                Store (0x74, P80H)
                Store (\_SB.PCI0.LPCB.EC.FNKC, \_SB.PCI0.LPCB.EC.HKLK)
                If (LEqual (HKLK, 0x00))
                {
                    \_SB.SGOV (0x0202000C, 0x01)
                }
                Else
                {
                    \_SB.SGOV (0x0202000C, 0x00)
                }

                FNSC (0x03, \_SB.PCI0.LPCB.EC.HKLK)
        ...
        Scope (\_SB.PCI0.LPCB.EC.HKEY)
        {
            ...
            Method (SWAN, 1, NotSerialized)
            {
                ...
                {
                    WPWC (0x01)
                    Store (0x01, \_SB.PCI0.LPCB.EC.RCWW)
                }
                Else
                {
                    WPWC (0x00)
                    Store (0x00, \_SB.PCI0.LPCB.EC.RCWW)
                }
            }
            ...
            Method (SBDC, 1, NotSerialized)
            {
                ...
                {
                    BPWC (0x01)
                    Store (0x01, \_SB.PCI0.LPCB.EC.RCBD)
                }
                Else
                {
                    BPWC (0x00)
                    Store (0x00, \_SB.PCI0.LPCB.EC.RCBD)
                }
            }
